...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.alertMessageBg').click(function () {
                $('.alertMessageBg').hide(3000);
            });
        });
    </script>
...
.btn{
    ...
    text-shadow: 0 1px 1px #F6F6F6;
    background-image: -moz-linear-gradient(top, #D9D9D9, #A6A6A6 49%, #A6A6A6 50%);
...
.alertMessageBg{
    width: 100%;
    height: 600px;
    background-image: url("${pageContext.request.contextPath}/images/all_bg.jpg");
...
<body background="${pageContext.request.contextPath}/images/books.png">
...
<div id="wrapper">
		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<form name="loginForm" action="<%=path%>/admin-login.action" method="post">
					<!-- start of login form -->
					<div id="welcome">
						<span id="welcome-text">管&nbsp;理&nbsp;登&nbsp;录</span>
					</div>
					<div id="user-name">
						<span class="item">管理员:</span>
	...
	<div id="footer">
		<div id="text">Copyright © 2015-2016 All Rights Reserved Powered By UIyllong</div>
	</div>
</div>
</body>
</html>